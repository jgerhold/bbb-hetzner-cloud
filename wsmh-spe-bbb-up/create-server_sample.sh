...
hcloud server create --name <turnservername> --image ubuntu-18.04 --type <servertype (small!)> --ssh-key joel@gmx.de --datacenter nbg1-dc3 --user-data-from-file ./cloud-config-turn.yml
